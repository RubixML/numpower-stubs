...
final class NumPower {
     ...
     */
    public static function multiply(NDArray|array|float|int $a, NDArray|array|float|int $b): NumPower|float|int {}
     ...
     * @return NDArray
     */
    public static function normal(array $size, float $loc = 0.0, float $scale = 1.0, int $accelerator = NUMPOWER_CPU): NDArray {}
     ...
     * @return NDArray
     */
    public static function uniform(array $size, float $low = 0.0, float $high = 1.0): NumPowNDArrayer {}
     ...
     * @return NDArray
     */
    public static function cholesky(NDArray|array $a): NumPower {}
